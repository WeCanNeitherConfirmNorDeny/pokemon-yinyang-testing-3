...
.useGoldBerryATKDEFEqualsShiny
	...
	or a
	cp SPDSPCDV_SHINY ; is spd/spc dv == shiny dv ?
	jp z,.vitaminNoEffect ; show no effect message - our pokemon is already shiny
	; else fall through
	dec hl ; fixes pointer
.useGoldBerryCopyShinyDVs
	; hl points to atk/def dv
	ld a, ATKDEFDV_SHINY ; a = shiny dv
